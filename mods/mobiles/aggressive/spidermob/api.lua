...
local mobs_present = minetest.global_exists("mobs")
if mobs_present and log_mods then
	minetest.log("action", "[spidermob] \"mobs\" mod present")
end

-- Defaults to using 'mobs' api
spidermob.use_mobs_api = mobs_present and minetest.settings:get_bool("spidermob.use_mobs_api") == true
